		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header" class="alt">
					<h1><a href="index.html">Skynet</a></h1>
					<nav id="nav">
						<ul>
				...
				<section id="main" class="container">
					...
					<section class="box special">
						<header class="major">
						  ...
						  <label for="toggle">Submit Photo</label>
						  <div id="expand">
								<p>Title:</p>
								<textarea class="doc" id="doc1" spellcheck="false"></textarea>
								<p>Description:</p>
								<textarea class="doc" id="doc2" spellcheck="false"></textarea>
				            <button id="submit-btn" onclick="post(‘index.php, {title: doc1.value, desc: doc2.value})">Submit</button>
  						</div>
					 </header>
				</section>
					<div class="row">
